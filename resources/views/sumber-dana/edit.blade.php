<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-0.5">Kode: {{ $sumberDana->kode_sumber }}</p>
                </div>
            </div>
            <div class="flex items-center gap-2">
                <a href="{{ route('sumber-dana.show', $sumberDana) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium rounded-xl shadow-sm transition-all">
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('sumber-dana.update', $sumberDana) }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-4 border-b border-green-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="font-semibold text-green-900">Edit Sumber Dana</p>
                        <p class="text-sm text-green-700 mt-0.5">Ubah pengaturan sumber dana di bawah ini</p>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_sumber" value="{{ old('kode_sumber', $sumberDana->kode_sumber) }}" required maxlength="50"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_sumber" value="{{ old('nama_sumber', $sumberDana->nama_sumber) }}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea name="deskripsi" rows="3"
                                ...
                                placeholder="Jelaskan sumber dana ini...">{{ old('deskripsi', $sumberDana->deskripsi) }}</textarea>
                        </div>
                        @error('deskripsi')
                            <p class="text-sm text-red-600 mt-1.5 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                    ...
                    <div>
                        <label class="flex items-center gap-3 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 cursor-pointer hover:from-green-100 hover:to-emerald-100 transition-all">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $sumberDana->is_active) ? 'checked' : '' }}
                            ...
                            <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm">
                                @if(old('is_active', $sumberDana->is_active))
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex items-center justify-end gap-3">
                <a href="{{ route('sumber-dana.show', $sumberDana) }}" class="inline-flex items-center gap-2 px-5 py-2.5 text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 font-medium rounded-xl shadow-sm transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                    Batal
