<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Pagu Baru</h1>
                <p class="text-gray-600 mt-1">Buat alokasi pagu anggaran untuk divisi</p>
            </div>
    ...
    <div class="max-w-3xl mx-auto py-8">
        <form method="POST" action="{{ route('penetapan-pagu.store') }}">
            @csrf
            ...
            <div class="mt-6 flex items-center justify-end space-x-4">
                <a href="{{ route('penetapan-pagu.index') }}" class="px-6 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">
                    Batal
                </a>
