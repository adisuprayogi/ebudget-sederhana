    ...
    <div class="max-w-3xl mx-auto py-8">
        <form method="POST" action="{{ route('penetapan-pagu.update', $penetapanPagu) }}">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="jumlah_pagu_display" class="currency-input w-full pl-12 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-right" placeholder="0" data-target="jumlah_pagu" value="{{ $penetapanPagu->jumlah_pagu }}">
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div class="grid grid-cols-3 gap-4 text-center">
                        ...
                        <div>
                            <div class="text-2xl font-bold text-orange-600">{{ formatRupiah($penetapanPagu->used_amount) }}</div>
                            <div class="text-xs text-orange-700">Terpakai</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-blue-600">{{ formatRupiah($penetapanPagu->remaining_amount) }}</div>
                            <div class="text-xs text-blue-700">Sisa</div>
                        </div>
                    </div>
                    <div class="mt-4">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <textarea name="catatan" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Tambahkan catatan atau keterangan tambahan...">{{ old('catatan', $penetapanPagu->catatan) }}</textarea>
                @error('catatan')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
