...
<header class="bg-white border-b border-gray-200">
    <div class="flex items-center justify-between h-16 px-6">
        ...
        <!-- Right Actions -->
        <div class="flex items-center gap-3" x-data="notificationCounter()">
            <!-- Notifications -->
            <a href="{{ route('notifications.index') }}" class="relative p-2 text-gray-600 hover:bg-gray-100 rounded-lg">
                ...
                <template x-if="unreadCount > 0">
                    <span class="absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] px-1 bg-red-500 text-white text-xs font-bold rounded-full" x-text="unreadCount > 99 ? '99+' : unreadCount"></span>
                </template>
            </a>
