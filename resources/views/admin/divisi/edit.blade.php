<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-0.5">{{ $divisi->nama_divisi }}</p>
                </div>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('admin.divisi.update', $divisi) }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gradient-to-r from-blue-50 to-orange-50 px-6 py-4 border-b border-blue-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="font-semibold text-blue-900">Edit Divisi</p>
                        <p class="text-sm text-blue-700 mt-0.5">Ubah data divisi di bawah ini</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="Deskripsi singkat tentang divisi...">{{ old('description', $divisi->description) }}</textarea>
                        </div>
                        @error('description')
                            <p class="text-sm text-red-600 mt-1.5 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
