<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto py-8">
        <form method="POST" action="{{ route('admin.approval-configs.update', $approvalConfig) }}" class="bg-white rounded-lg shadow-sm p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $approvalConfig->is_active) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
