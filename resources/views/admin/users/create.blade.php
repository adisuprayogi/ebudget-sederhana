<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-0.5">Buat user baru untuk sistem</p>
                </div>
            </div>
    ...
    <div class="max-w-5xl mx-auto">
        <form method="POST" action="{{ route('admin.users.store') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            @csrf
            ...
            <div class="bg-gradient-to-r from-blue-50 to-orange-50 px-6 py-4 border-b border-blue-100">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-700 mt-0.5">Lengkapi data diri user di bawah ini</p>
                    </div>
                </div>
            </div>
