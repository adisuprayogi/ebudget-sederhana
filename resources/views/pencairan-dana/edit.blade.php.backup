            ...
            <div class="mb-8 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="font-mono text-lg font-semibold text-primary-600">{{ $pencairan->pengajuanDana->nomor_pengajuan }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-primary-600">{{ formatRupiah($pencairan->pengajuanDana->total_pengajuan) }}</p>
                    </div>
                    <div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-3 bg-white border border-secondary-200 rounded-lg">
                        ...
                        <div class="flex items-center space-x-2">
                            <a href="{{ $lampiran->file_url }}" target="_blank" class="text-primary-600 hover:text-primary-800 text-sm">Lihat</a>
