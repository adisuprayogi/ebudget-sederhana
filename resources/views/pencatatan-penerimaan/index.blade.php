    ...
    <div class="py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl p-6 text-white shadow-soft">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-blue-100 text-sm font-medium">Total Pencatatan</p>
                        <p class="text-3xl font-bold mt-1">{{ $pencatatanPenerimaans->total() ?? 0 }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-400 to-green-600 rounded-2xl p-6 text-white shadow-soft">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-green-100 text-sm font-medium">Total Diterima</p>
                        <p class="text-2xl font-bold mt-1">{{ formatRupiah($summary['total_diterima'] ?? 0) }}</p>
                    </div>
                    <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-2xl shadow-soft p-6 mb-6">
            <form method="GET" action="{{ route('pencatatan-penerimaan.index') }}" class="flex flex-wrap gap-4">
                ...
                <div class="flex-1 min-w-[180px]">
                    <label class="block text-sm font-medium text-secondary-700 mb-2">Sumber Dana</label>
                    <select name="sumber_dana_id" class="w-full px-4 py-2 border border-secondary-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                ...
                <div class="flex-1 min-w-[180px]">
                    <label class="block text-sm font-medium text-secondary-700 mb-2">Referensi Perencanaan</label>
                    <select name="perencanaan_penerimaan_id" class="w-full px-4 py-2 border border-secondary-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent">
